...
console.log(
  'LA Time:',
  new Date(
    dateParamToTimestamp('05-17-2025', 'America/Los_Angeles'),
  ).toLocaleString(),
);
console.log(
  'UTC Time:',
  new Date(dateParamToTimestamp('05-17-2025')).toLocaleString(),
);
console.log(
  'NY Time:',
  new Date(
    dateParamToTimestamp('05-17-2025', 'America/New_York'),
  ).toLocaleString(),
);
